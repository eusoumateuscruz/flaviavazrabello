...
export const PRACTICE_AREAS = [
   {
    ...
    services: [
      ...
      "Casamento Civil e Anulação",
      "União Estável (reconhecimento e dissolução)",
      "Direito Homoafetivo e Multiparentalidade",
      "Divórcio Consensual e Litigioso (Judicial e Extrajudicial)",
      "Partilha de Bens",
      "Guarda Compartilhada, Alternada ou Unilateral",
      "Modificação de Guarda",
      "Pensão Alimentícia (fixação, revisão, execução e exoneração)",
      "Regulamentação e Revisional de Visitas",
      "Investigação de Paternidade",
      "Autorização de Viagem de Menor de Idade",
      "Retificação de Registro Civil (mudança de nome e/ou sobrenome)",
      "Alienação Parental",
      "Adoção",
